    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_record://保存
                FlightInformation.demLat = new ArrayList<Double>();
                FlightInformation.demLng = new ArrayList<Double>();
                FlightInformation.demAltitude = new ArrayList<Double>();
                FlightInformation.demPitch = new ArrayList<Double>();
                FlightInformation.demRoll = new ArrayList<Double>();
                FlightInformation.demYaw = new ArrayList<Double>();
                FlightInformation.demTime = new ArrayList<String>();
                //loginAccount();
                //updateDroneLocation();
                break;
    ...
    private void updateDroneLocation(){
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                //--------------------------------------------------------
                FlightInformation.demLat.add(droneLocationLat);//把无人机当前经纬保存进数组
                FlightInformation.demLng.add(droneLocationLng);
                FlightInformation.demAltitude.add(droneLocationAlt);
                FlightInformation.demPitch.add(droneAttitudePitch);
                FlightInformation.demRoll.add(droneAttitudeRoll);
                FlightInformation.demYaw.add(droneAttitudeYaw);

                Calendar nowd = Calendar.getInstance();

                FlightInformation.demTime.add(""+nowd.get(Calendar.YEAR)+'_'+nowd.get(Calendar.MONTH)+'_'+nowd.get(Calendar.DAY_OF_MONTH)+'-'+nowd.get(Calendar.HOUR_OF_DAY)+':'+nowd.get(Calendar.MINUTE)+':'+nowd.get(Calendar.SECOND)+':'+nowd.get(Calendar.MILLISECOND));
//
//                tTime.setText(droneTime);
//                tLng.setText(""+droneLocationLng);
//                tLat.setText(""+droneLocationLat);
//                tAlt.setText(""+droneLocationAlt);
//                tPitch.setText(""+droneAttitudePitch);
//                tRoll.setText(""+droneAttitudeRoll);
//                tYaw.setText(""+droneAttitudeYaw);
                // }
            }
        });
    }
    ...
    private void outputGPStoFile(String FileName)
    {
        ...
        if(state.equals(android.os.Environment.MEDIA_MOUNTED)) {
            ...
            try{
                ...
                // 输出坐标数量
                bw.write("" + FlightInformation.demTime.size());
                bw.newLine();
                bw.write("Time    Lng    Lat    Alt    Yaw    Pitch    Roll");
                bw.newLine();
                //遍历集合
                int len = FlightInformation.demLat.size();
                for (int i=0; i<len; i++) {
                    bw.write("" + FlightInformation.demTime.get(i));
                    bw.write("    ");
                    bw.write("" + FlightInformation.demLng.get(i));
                    bw.write("    ");
                    bw.write("" + FlightInformation.demLat.get(i));
                    bw.write("    ");
                    bw.write("" + FlightInformation.demAltitude.get(i));
                    bw.write("    ");
                    bw.write("" + FlightInformation.demYaw.get(i));
                    bw.write("    ");
                    bw.write("" + FlightInformation.demPitch.get(i));
                    bw.write("    ");
                    bw.write("" + FlightInformation.demRoll.get(i));
                    bw.newLine();
                    bw.flush();
                }
                // //释放资源
